...
DEFINITION      <- WS? ((MODULE_DCL / CONST_DCL / STRUCT_DCL / ENUM_DCL / UNION_DCL / TYPEDEF_DCL) SEMICOLON
                 / PREPROCESSOR)
...
MEMBER          <- ANNOTATION* TYPE_SPEC DECLARATOR SEMICOLON
...
# Typedefs
TYPEDEF_DCL     <- KW_TYPEDEF TYPE_SPEC DECLARATOR
...
PRIMARY_EXPR    <- OPEN_PAREN CONST_EXPR CLOSE_PAREN / HEX_LITERAL / DEC_LITERAL / SCOPED_NAME
