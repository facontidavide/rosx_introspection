...
TEST_CASE("Parse ROS2 JSON [JointState]")
{
  ...
  CHECK( flat_container->value[0].first.toStdString() == ("joint_state/header/stamp/sec"));
  CHECK( flat_container->value[0].second.convert<uint32_t>() - joint_state.header.stamp.sec <=0.001 );
  CHECK( flat_container->value[1].first.toStdString() == ("joint_state/header/stamp/nanosec"));
  CHECK( flat_container->value[1].second.convert<uint32_t>() - joint_state.header.stamp.nanosec <=0.001  );
